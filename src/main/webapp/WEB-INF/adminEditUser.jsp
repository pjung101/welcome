...
<body>
    ...
    <section class="contact-wrap">
        ...
        <p class="red">${error}</p>
        <form:form method="POST" action="/admin/${user.id}/editUser" modelAttribute="user" class="contact-form">
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <div class="input-block">
                    <p>
                        <form:label path="adminLevel">Admin Level:</form:label>
                        <form:input type="text" path="adminLevel" class="form-control"/>
                    </p>
                </div>
            </div>
            <div class="col-sm-12">
