...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
    ...
    <div class = "container">
        ...
        <div class="shipping">
            <form:errors path="editShippingAddress.*"/>
            <form:form method="POST" action="/user/${originalShippingAddress.id}/editShippingAddress" modelAttribute="editShippingAddress">
                <p>
