...
<body>
    ...
    <section class="contact-wrap">
        <h1>Edit ${originalVendor.companyName}</h1>
        <form:errors path="originalVendor.*"/>
        <form:form method="POST" action="/vendor/editVendorAccount" modelAttribute="vendor" class="contact-form">
            <div class="col-sm-12">
