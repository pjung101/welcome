...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
    ...
    <section class="contact-wrap">
        ...
        <h1>Billing</h1>
            ...
            <form:form method="POST" action="/user/newBilling" modelAttribute="newBilling" class="contact-form">
                <div class="col-sm-12">
                ...
                <p>
                    ...
                    <form:input path="eMonth"/>
                    <form:label path="eYear">Exp Year:</form:label>
                    <form:input path="eYear"/>
                </p>
                </div>
                </div>
                <div class="col-sm-12">
