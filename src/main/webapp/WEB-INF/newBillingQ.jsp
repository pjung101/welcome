...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.0/css/bootstrap.css">
...
<body>
    ...
    <section class="contact-wrap">
        <h1>Billing</h1>
        <form:errors path="newBilling.*" />
        <form:form method="POST" action="/user/quasiAddBilling" modelAttribute="newBilling" class="contact-form">
            <div class="col-sm-12">
                <div class="input-block">
                    <p>
                        <form:label path="creditCard">Credit Card Number:</form:label>
                        <form:input path="creditCard" class="form-control"/>
                    </p>
                </div>
            </div>
            <div class="col-sm-12">
                <div class="input-block">
                    <p>
                        <form:label path="csvCode">Security Code:</form:label>
                        <form:input path="csvCode" class="form-control"/>
                    </p>
                </div>
            </div>
            <div class="col-sm-12 quick">
                <div class="input-block">
                    <p>
                        <form:label path="eMonth">Exp Month:</form:label>
                        <form:input path="eMonth" class="form-control"/>
                    </p>
                </div>
            </div>
            <div class="col-sm-12 quick">
                    <div class="input-block">
                        <p>
                            <form:label path="eYear">Exp Year:</form:label>
                            <form:input path="eYear" class="form-control"/>
                        </p>
                    </div>
                </div>
            <div class="col-sm-12">
