...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <a class="navbar-brand" href="/vendor/dashboard">Dashboard</a>
    ...
    <section class="contact-wrap">
        <h1>Edit ${originalProduct.name}</h1>
        <form:errors path="product.*"/>
        <form:form method="POST" action="/vendor/${product.id}/edit" modelAttribute="product" class="contact-form">
            ...
            <div class="col-sm-12">
                <div class="input-block">
                    <p>
                        <form:label path="imageHash">Link of Image:</form:label>
                        <form:input path="imageHash" class="form-control"/>
                    </p>
                </div>
            </div>
            <div class="col-sm-12">
                <button class="square-button" type="submit">Edit</button>
            </div>
